    ...
    <div style={{ padding: "24px 40px", maxWidth: 1400, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
        <div>
          ...
          <p style={{ color: text2, fontSize: 14, marginTop: 4 }}>
            Comprehensive control of income, expenses, and billing for the Medical SaaS platform.
          </p>
        </div>
          ...
          {["month", "quarter", "year", "all"].map((f) => (
            <button
              ...
              style={{
                ...
                color: dateFilter === f ? text1 : text3,
                cursor: "pointer",
              }}
            >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 24, marginBottom: 32 }}>
        <GCard style={{ padding: 24 }}>
          <h3 style={{ fontSize: 16, fontWeight: 700, color: text1, marginBottom: 24 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
        <GCard style={{ padding: 0, overflow: "hidden" }}>
          ...
          >
            ...
            <button style={{ fontSize: 12, color: accent, background: "none", border: "none", cursor: "pointer" }}>
              See all
            </button>
          </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <button onClick={onClose} style={{ background: "none", border: "none", cursor: "pointer", color: text3 }}>
            <Ico name="X" size={20} />
          </button>
        </div>
            ...
            <>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  <label style={{ fontSize: 11, fontWeight: 700, color: text3, textTransform: "uppercase" }}>
                    Patient
                  </label>
                  <select
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      setFormData({
                        ...
                        doctorName: d?.name || d?.displayName || "",
                      });
                    }}
                    style={selectStyle}
                  >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                >
                  ...
                  <option value="Transfer" style={optionStyle}>
                    Transfer
                  </option>
                  <option value="Insurance" style={optionStyle}>
                    Medical Insurance
                  </option>
                </select>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <select
                    ...
                    style={selectStyle}
                  >
                    <option value="Rent" style={optionStyle}>
                      Rent
                    </option>
                    <option value="Supplies" style={optionStyle}>
                      Supplies
                    </option>
                    <option value="Salaries" style={optionStyle}>
                      Salaries
                    </option>
                    <option value="Services" style={optionStyle}>
                      Services
                    </option>
                    <option value="Others" style={optionStyle}>
                      Others
                    </option>
                  </select>
                </div>

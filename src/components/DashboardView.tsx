    ...
    return (
      <div style={{ height: "100%", display: "flex", alignItems: "center", justifyContent: "center", padding: 40 }}>
        <div style={{ maxWidth: 500, textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: 28, fontWeight: 900, color: text1, marginBottom: 12, letterSpacing: "-0.03em" }}>
            Welcome to Medical SaaS
          </h2>
          <p style={{ color: text2, fontSize: 16, lineHeight: 1.6, marginBottom: 32 }}>
            Your private workspace is ready. As you are the administrator of this clinic, you can start registering
            patients or use our testing tools.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <GCard
              style={{ padding: 20, textAlign: "left", cursor: "pointer", transition: "all 0.2s" }}
            ...
            <GCard
              style={{ padding: 20, textAlign: "left", cursor: "pointer", transition: "all 0.2s" }}
              onMouseEnter={(e) => (e.currentTarget.style.borderColor = danger)}
              onMouseLeave={(e) => (e.currentTarget.style.borderColor = glass.border)}
            >
        ...
        <GCard style={{ height: 260, padding: "20px 24px", display: "flex", flexDirection: "column" }}>
          <div style={{ marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 11, color: text3, marginTop: 2 }}>
              Appointments vs New Patients over the last 7 days
            </p>
          </div>
          ...
          >
            <div>
              ...
              <p style={{ fontSize: 11, color: text2, marginTop: 2 }}>
                ...
                {stats.appointments} scheduled appointments
              </p>
            </div>
            <button
              style={{

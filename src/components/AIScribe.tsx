        ...
        {!isRecording && !isProcessing ? (
          <motion.div key="start" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <p style={{ fontSize: 14, color: text2, marginBottom: 24, maxWidth: 400, margin: "0 auto 24px" }}>
              Record the conversation with the patient. The AI will automatically transcribe and extract the reason,
              evolution, vital signs, and diagnosis.
            </p>
          ...
          <motion.div key="recording" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 32, fontWeight: 700, color: text1, fontFamily: "monospace" }}>
          ...
          <motion.div key="processing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <div style={{ marginBottom: 24 }}>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, color: text1, marginBottom: 8 }}>
                AI Analyzing Consultation
              </h3>

        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:14 }}>
          {metrics.map(m => (
            <GCard key={m.label} style={{ padding:"20px 20px 16px", position:"relative", overflow:"hidden",
              ...
              <p style={{ fontSize:11, fontWeight:600, letterSpacing:"0.06em", color:text2, marginBottom:4 }}>{m.label.toUpperCase()} (SEC)</p>
          ...
          <div style={{ padding:"20px 24px 16px", borderBottom:`1px solid ${glass.border}`,
            ...
            <div>
              ...
              <p style={{ fontSize:11, color:text2, marginTop:2 }}>
                {new Date().toLocaleDateString('en-US', { weekday: 'long', day: 'numeric', month: 'long' })} · {stats.appointments} appointments scheduled
              </p>
            </div>
          </div>

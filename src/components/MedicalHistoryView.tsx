...
export function MedicalHistoryView({ patientId, onBack, onNewConsultation }: Props) {
  ...
  if (role !== "DOCTOR" && role !== "ADMIN") {
    return (
      <GCard
        style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: 40, textAlign: "center" }}
      >
        <div>
          ...
          <p style={{ fontSize: 14, color: text3, maxWidth: 300, margin: "12px auto 0" }}>
            Only authorized medical personnel can access the electronic medical record.
          </p>
        </div>
      </GCard>
    );
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              {isEditing ? (
                ...
                <h2 style={{ fontSize: 22, fontWeight: 800, color: text1, letterSpacing: "-0.02em" }}>
                  {patient?.name}
                </h2>
              )}
              <div
                style={{
                  padding: "4px 10px",
                  borderRadius: 20,
                  background: getInsuranceStatusColor(patient?.insuranceStatus) + "22",
                  border: `1px solid ${getInsuranceStatusColor(patient?.insuranceStatus)}44`,
                  color: getInsuranceStatusColor(patient?.insuranceStatus),
                  fontSize: 10,
                  fontWeight: 800,
            ...
            <p style={{ fontSize: 13, color: text2, marginTop: 2 }}>
              <span style={{ color: text3 }}>ID:</span>{" "}
              {isEditing ? (
                <input
                  value={editData.dni || ""}
              ...
              •<span style={{ color: text3, marginLeft: 8 }}>Age:</span>{" "}
              {isEditing ? (
                <input
                  type="number"
                  value={editData.age || ""}
              ...
              years •<span style={{ color: text3, marginLeft: 8 }}>Blood:</span>{" "}
              {isEditing ? (
                <select
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 12 }}>
          {isEditing && (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                fontSize: 13,
                boxShadow: `0 8px 20px ${success}44`,
              }}
            >
          ...
          <button
            ...
            style={{
              ...
              padding: "10px 18px",
              borderRadius: 12,
              background: isEditing ? danger + "22" : glass.navItem,
              color: isEditing ? danger : text1,
              fontWeight: 700,
              border: `1px solid ${isEditing ? danger + "44" : glass.border}`,
              cursor: "pointer",
              fontSize: 13,
            }}
          >
          ...
          <GCard style={{ padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                {
                  label: "Smoking",
                  value: (isEditing ? editData.lifestyle?.smoking : patient?.lifestyle?.smoking) || "Never",
                  icon: "Cigarette",
                  key: "smoking",
                  options: ["Never", "Occasional", "Frequent", "Ex-smoker"],
                },
                {
                  label: "Alcohol",
                  value: (isEditing ? editData.lifestyle?.alcohol : patient?.lifestyle?.alcohol) || "Never",
                  icon: "GlassWater",
                  key: "alcohol",
                ...
                },
                {
                  ...
                  value: (isEditing ? editData.lifestyle?.activity : patient?.lifestyle?.activity) || "Sedentary",
                  icon: "Dumbbell",
                  key: "activity",
                ...
                {
                  label: "Sleep Quality",
                  value: (isEditing ? editData.lifestyle?.sleep : patient?.lifestyle?.sleep) || "Good",
                  icon: "Moon",
                  key: "sleep",
                    ...
                    {!isEditing && (
                      <div
                        style={{
                          ...
                          height: 8,
                          borderRadius: "50%",
                          background: getLifestyleColor(item.key, item.value),
                          boxShadow: `0 0 8px ${getLifestyleColor(item.key, item.value)}66`,
                        }}
                      />
                    )}
                  </div>
                  ...
                  {isEditing ? (
                    ...
                    >
                      {item.options.map((opt) => (
                        <option key={opt} value={opt} style={{ background: "#1a1a24" }}>
                          {opt}
                        </option>
                      ))}
                    </select>
              ...
              {isEditing ? (
                <>
                  {[
                    ...
                    >
                      <p style={{ fontSize: 9, color: text3, textTransform: "uppercase", marginBottom: 4 }}>
                        {v.label}
                      </p>
                      <input
                ...
                [
                  {
                    ...
                    value: latestVitals ? `${latestVitals.bpS}/${latestVitals.bpD}` : "--",
                    unit: "mmHg",
                    icon: "Gauge",
                  },
                  ...
                  {
                    label: "BMI",
                    value: latestVitals ? calculateBMI(latestVitals.weight, latestVitals.height) : "--",
                    unit: "",
                    icon: "Scale",
                    highlight: true,
                  },
                  ...
                  >
                    ...
                    <p style={{ fontSize: 14, fontWeight: 700, color: text1 }}>
                      {v.value} <span style={{ fontSize: 9, fontWeight: 400, color: text3 }}>{v.unit}</span>
                    </p>
                  </div>
                ))
              )}
              ...
              {(isEditing ? editData.vaccinations : patient?.vaccinations)?.map((v, i) => (
                ...
                >
                  <div>
                    ...
                    <p style={{ fontSize: 10, color: text3 }}>
                      {v.date} • {v.dose || "Single dose"}
                    </p>
                  </div>
                  {isEditing && (
                    <button
              ...
              {isEditing && (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 800,
                    cursor: "pointer",
                    boxShadow: `0 4px 12px ${success}44`,
                  }}
                >
                  Save
                </button>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              {isEditing && (
                <div>
                  ...
                  >
                    <option value="Active" style={{ background: "#1a1a24" }}>
                      Active
                    </option>
                    <option value="Pre-authorization" style={{ background: "#1a1a24" }}>
                      Pre-authorization
                    </option>
                    <option value="Inactive" style={{ background: "#1a1a24" }}>
                      Inactive
                    </option>
                  </select>
                </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p style={{ fontSize: 14, color: text1, fontWeight: 700 }}>
                    {patient?.insurance || "Not registered"}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: isEditing ? 8 : 0 }}>
                  ...
                  {!(isEditing ? editData.allergiesList : patient?.allergiesList)?.length && !isEditing && (
                    <p style={{ fontSize: 13, color: text3 }}>None known</p>
                  )}
                </div>
                {isEditing && (
                  <div style={{ display: "flex", gap: 8 }}>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p style={{ fontSize: 13, color: text2, lineHeight: 1.5 }}>
                    {patient?.pathologicalHistory || "No records"}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p style={{ fontSize: 13, color: text2, lineHeight: 1.5 }}>
                    {patient?.surgicalHistory || "No records"}
                  </p>
                )}
              </div>
                  ...
                  {(isEditing ? editData.attachments : patient?.attachments)?.map((file, i) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p style={{ fontSize: 9, color: text3 }}>
                          {file.date} • {file.size || "---"}
                        </p>
                      </div>
        ...
        {(printingConsultation || printingSummary) && (
          ...
          >
            ...
            >
              ...
              <div
                id="printable-report"
                style={{ flex: 1, padding: 60, overflowY: "auto", color: "#000", fontFamily: "var(--font-sans)" }}
              >
                {printingSummary ? (
                  <>
                    <div
                    ...
                    <div style={{ marginBottom: 30 }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
                        ...
                        <p style={{ fontSize: 13 }}>
                          <strong>Insurance:</strong> {patient?.insurance} ({patient?.insuranceStatus})
                        </p>
                      </div>
                    </div>
                    ...
                    <div style={{ marginBottom: 30 }}>
                      ...
                      <p style={{ fontSize: 13, marginBottom: 8 }}>
                        <strong>Pathological:</strong> {patient?.pathologicalHistory || "No records"}
                      </p>
                      <p style={{ fontSize: 13, marginBottom: 8 }}>
                        <strong>Surgical:</strong> {patient?.surgicalHistory || "No records"}
                      </p>
                      <p style={{ fontSize: 13, marginBottom: 8 }}>
                        <strong>Hereditary:</strong> {patient?.hereditary || "No records"}
                      </p>
                      <p style={{ fontSize: 13, marginBottom: 8 }}>
                        <strong>Allergies:</strong> {patient?.allergiesList?.join(", ") || "None known"}
                      </p>
                    </div>
                    ...
                    <div style={{ marginBottom: 30 }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
                        ...
                        <p style={{ fontSize: 13 }}>
                          <strong>Activity:</strong> {patient?.lifestyle?.activity}
                        </p>
                        <p style={{ fontSize: 13 }}>
                    ...
                    <div style={{ marginBottom: 30 }}>
                      ...
                      {consultations.map((c, i) => (
                        <div
                          key={i}
                          style={{ marginBottom: 20, padding: 10, border: "1px solid #eee", borderRadius: 4 }}
                        >
                    ...
                    <>
                      ...
                      >
                        ...
                        <div style={{ textAlign: "right" }}>
                          ...
                          <p style={{ fontSize: 12, color: "#666" }}>
                            Consultation ID: {printingConsultation.id.slice(0, 8)}
                          </p>
                        </div>
                      </div>
                      ...
                      <div style={{ marginBottom: 30 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 15 }}>
                          <div>
                            <p style={{ fontSize: 10, color: "#666" }}>BLOOD PRESSURE</p>
                            <p style={{ fontSize: 14, fontWeight: 700 }}>
                              {printingConsultation.vital_signs.bpS}/{printingConsultation.vital_signs.bpD}{" "}
                              <span style={{ fontSize: 10 }}>mmHg</span>
                            </p>
                          </div>
                          <div>
                            <p style={{ fontSize: 10, color: "#666" }}>PULSE</p>
                            <p style={{ fontSize: 14, fontWeight: 700 }}>
                              {printingConsultation.vital_signs.pulse} <span style={{ fontSize: 10 }}>bpm</span>
                            </p>
                          </div>
                          <div>
                            <p style={{ fontSize: 10, color: "#666" }}>TEMP</p>
                            <p style={{ fontSize: 14, fontWeight: 700 }}>
                              {printingConsultation.vital_signs.temp} <span style={{ fontSize: 10 }}>°C</span>
                            </p>
                          </div>
                          <div>
                            <p style={{ fontSize: 10, color: "#666" }}>WEIGHT</p>
                            <p style={{ fontSize: 14, fontWeight: 700 }}>
                              {printingConsultation.vital_signs.weight} <span style={{ fontSize: 10 }}>kg</span>
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div style={{ marginBottom: 30 }}>
                        ...
                        <p style={{ fontSize: 13, marginBottom: 12 }}>
                          <strong>Reason:</strong> {printingConsultation.reason}
                        </p>
                        <p style={{ fontSize: 13, lineHeight: 1.6 }}>
                          <strong>Evolution:</strong> {printingConsultation.evolution}
                        </p>
                      </div>
                ...
                <div style={{ marginTop: 80, display: "flex", justifyContent: "center" }}>
                  <div style={{ textAlign: "center", borderTop: "1px solid #000", width: 250, paddingTop: 10 }}>
                    <p style={{ fontSize: 14, fontWeight: 700 }}>
                      {printingConsultation?.doctorName || "Attending Doctor"}
                    </p>

...
export function SettingsView() {
  ...
  const handlePopulate = async () => {
    ...
    try {
      ...
      toast.success("Database populated successfully! Please navigate to Dashboard to see changes.", {
        id: loadingToast,
      });
    } catch (error: any) {
    ...
    <div style={{ maxWidth: 800, margin: "0 auto", padding: 24 }}>
      ...
      <div style={{ display: "grid", gap: 24 }}>
        <GCard style={{ padding: 24 }}>
          <div style={{ display: "flex", gap: 24, alignItems: "center", marginBottom: 32 }}>
            <div style={{ position: "relative" }}>
              <img
                src={clinic.logo || "https://picsum.photos/seed/clinic/200/200"}
                alt="Logo"
                style={{
                  width: 100,
                  height: 100,
            ...
            <div>
              ...
              <p style={{ fontSize: 13, color: text2, marginTop: 4 }}>
                It will be displayed on prescriptions, invoices, and reports.
              </p>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            <Field
              label="Clinic Name"
              value={clinic.name || ""}
              onChange={(v: string) => setClinic({ ...clinic, name: v })}
            />
            <Field
              label="Email Address"
              value={clinic.email || ""}
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
          {saveSuccess && (
            <div
              style={{ display: "flex", alignItems: "center", gap: 8, color: success, fontSize: 14, fontWeight: 600 }}
            >
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                ...
                <p style={{ fontSize: 12, color: text2, marginTop: 4 }}>
                  Inject synthetic records, patients, and history. Clears on logout.
                </p>
              </div>
              <button

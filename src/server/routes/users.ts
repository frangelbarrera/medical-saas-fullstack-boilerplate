...
usersRouter.get("/api/users", authenticateToken, requireRole("ADMIN", "DOCTOR", "SECRETARY"), async (req: AuthenticatedRequest, res) => {
...
usersRouter.post("/api/users", authenticateToken, requireRole("ADMIN"), validateBody(schemas.userCreate), async (req: AuthenticatedRequest, res) => {
...
usersRouter.put("/api/users/:id", authenticateToken, requireRole("ADMIN"), validateBody(schemas.userUpdate), async (req: AuthenticatedRequest, res) => {
...
usersRouter.delete("/api/users/:id", authenticateToken, requireRole("ADMIN"), async (req: AuthenticatedRequest, res) => {
  try {
